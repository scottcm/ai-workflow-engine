...
**File Output:**
Create a file named `planning-response.md` containing the complete planning document.

**Document Header:**
Start with metadata in YAML format:
```yaml
---
Generated by: [Your AI model name and version, e.g., "Claude Sonnet 4", "Gemini 2.0 Flash"]
