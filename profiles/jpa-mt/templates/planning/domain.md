...
profile: {{PROFILE}}
iteration: {{ITERATION}}
llm-used: [To be filled by AI in response]
---
...
The developer will review your plan. You will only proceed to the next phase when you receive a new request that explicitly approves the plan.
...
### PHASE 2 – CODE GENERATION (FUTURE PHASE)

This is **NOT** your task now. A separate generation prompt will be issued for Phase 2 **after** the plan you create in Phase 1 has been approved by the developer.
...
Generate a single planning document in Markdown format with the following sections.
...
**Ready for Code Generation:** [Yes / No, pending clarifications]
