...
class TestRevisionPromptGeneration:
    ...
    def test_revision_prompt_does_not_contain_code_files_placeholder(self, jpa_mt_profile):
        """Revision template should not contain {{CODE_FILES}} - engine injects code now.
